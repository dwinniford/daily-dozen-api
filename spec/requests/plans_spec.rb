...
RSpec.describe "/plans", type: :request do
  ...
  # PlansController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get plans_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Plan" do
        expect {
          post plans_url,
               params: { plan: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Plan" do
        expect {
          post plans_url,
               params: { plan: invalid_attributes }, as: :json
  ...
  describe "DELETE /destroy" do
    it "destroys the requested plan" do
      plan = Plan.create! valid_attributes
      expect {
        delete plan_url(plan), headers: valid_headers, as: :json
      }.to change(Plan, :count).by(-1)
    end
  end
end
